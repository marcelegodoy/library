def cpf_valid?(cpf)
  null_cpfs = %w{12345678909 11111111111 22222222222 33333333333 44444444444 55555555555 66666666666 77777777777 88888888888 99999999999 00000000000 12345678909}

  return false if null_cpfs.include?(cpf)
  return false unless cnpj.length == 11

  cpf_array = cpf.scan /[0-9]/
  valor = cpf_array.collect{|x| x.to_i}
  ...
  if resultado1 == valor[9]
    ...
    resultado2 == valor[10] # CPF válido
